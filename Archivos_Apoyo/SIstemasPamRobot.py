...
def Sistema_Musculos_PAM_20(control_joint_names=None):
    ...
    for joint in control_joint_names:
        if "hip_roll" in joint:
            ...
            pam_dict[f"{joint}_extensor"] = PAMMcKibben(L0=0.6, r0=0.052, alpha0=np.pi/4)
        elif "hip_pitch" in joint:
            ...
            pam_dict[f"{joint}_flexor"] = PAMMcKibben(L0=0.5, r0=0.056, alpha0=np.pi/4)
            pam_dict[f"{joint}_extensor"] = PAMMcKibben(L0=0.5, r0=0.056, alpha0=np.pi/4)
        elif "ankle_roll" in joint:
